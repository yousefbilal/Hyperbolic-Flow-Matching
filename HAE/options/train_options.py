...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--feature_size', default=256, type=int, help='Dimension of latent code in hyperbolic space')
		...
		self.parser.add_argument('--contrastive_lambda', default=0.1, type=float, help='Un/Supervised Contrastive loss factor for hyperbolic feature learning')
		self.parser.add_argument('--hyperbolic_lambda', default=0.1, type=float, help='Supervised hyperbolic loss for hyperbolic feature learning')
		self.parser.add_argument('--reverse_lambda', default=0.1, type=float, help='Project back to the original Euclidean space')

		self.parser.add_argument('--stylegan_weights', default=model_paths['stylegan_ffhq'], type=str, help='Path to StyleGAN model weights')
		self.parser.add_argument('--checkpoint_path', default=None, type=str, help='Path to HAE model checkpoint')
